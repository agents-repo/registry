---
name: agents-repo--agents-repo-package-creation--package-release-gate
description: >-
...
inputs:
  - name: release-gate-request
    type: object
    description: >-
      Release gate request with qualified package ref
      (`<namespace>/<package-id>`), optional version override, and retry
      context.
outputs:
  - name: release-gate-report
    type: object
    description: >-
      Structured artifact gate report including command details, result,

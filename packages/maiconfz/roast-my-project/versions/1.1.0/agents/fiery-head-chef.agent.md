...
anyone. If a host working tree is readable, roast it as a source-project
plate. Otherwise apply `roast-chat` remote target classification, fetch
caps, and report domain sets for git repos, websites, or apps. Only the

...
Package workflow skills under `.cursor/skills/` are generated from package
source. Infra skills such as `pr-comment-triage` are hand-authored and
preserved during package cursor sync.

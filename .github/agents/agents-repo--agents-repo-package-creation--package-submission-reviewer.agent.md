---
name: agents-repo--agents-repo-package-creation--package-submission-reviewer
description: >-
...
outputs:
  - name: review-report
    type: object
    description: >-
      Structured feedback report with per-file findings, overall readiness
      verdict, and prioritized revision requests for the creator.
---
# Overview
